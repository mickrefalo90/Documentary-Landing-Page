...
export default function ContactForm() {
  ...
  if (status === "success") {
    return (
      ...
      >
        <h3 className="text-3xl font-bold text-steel-blue mb-2">You're on the list!</h3>
        <p className="text-xl text-white/60">We'll notify you when the Kickstarter goes live in Q1 FY27.</p>
      </motion.div>
    );
  }
  ...
  return (
    <>
      ...
      >
        ...
        <div className="space-y-2">
          <label className="text-xs font-mono uppercase tracking-widest text-white/40 ml-1">Message (Optional)</label>
          <textarea
            rows={4}
        ...
        <button
          ...
          className="w-full bg-steel-blue hover:bg-mint-cream text-ink-black font-bold py-3 md:py-4 rounded-xl transition-all transform active:scale-[0.98] disabled:opacity-50 text-base md:text-lg"
        >
